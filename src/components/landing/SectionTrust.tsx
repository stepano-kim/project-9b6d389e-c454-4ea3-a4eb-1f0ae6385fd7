  ...
  return <section className="section-padding bg-card/30">
      <div className="container-tight">
        <div className="text-center mb-12">
          <AnimatedTitle className="text-3xl md:text-4xl lg:text-[2.75rem] font-bold text-foreground mb-4 text-balance tracking-tight">
            {"믿을 수 있는 에너지 공기업의\nNo.1 파트너"}
          </AnimatedTitle>
          <motion.p
            ...
            className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto text-balance leading-relaxed"
          >
