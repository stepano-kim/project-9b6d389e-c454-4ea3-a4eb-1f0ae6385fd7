...
const benefits = [
  {
    ...
    headline: "에너지 공기업 선투자로\n초기 구축 비용 제로",
    body: "에너지 공기업의 선투자 구조를 통해\n건물은 초기 구축 비용 부담 없이\n에너지 최적화를 시작할 수 있습니다.",
  },
  {
    image: benefitEnergySaving,
    headline: "에너지 최적화 설계로\n전기료 절감",
    body: "건물 운영과 설비 특성에 맞춘\n에너지 최적화 설계를 통해\n실질적인 전기료 절감을 만듭니다.",
  },
  {
    image: benefitEsgData,
    headline: "ESG 대응 데이터까지\n한 번에 해결",
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <div className="p-6 md:p-7">
                <h3 className="text-lg md:text-xl font-bold text-foreground mb-3 leading-snug whitespace-pre-line">
                  {benefit.headline}
                </h3>
